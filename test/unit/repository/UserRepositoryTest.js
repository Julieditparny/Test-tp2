...
// Get user by ID
  describe("UserRepository", function() {
    ...
    it("should throw exception 'User doesn't exist'", function(){
        var mockDb = jasmine.createSpyObj('db', ['get', 'push', 'write', 'find', 'value']);
        mockDb.get.and.returnValue(mockDb);
        mockDb.push.and.returnValue(mockDb);
        mockDb.find.and.returnValue(mockDb);
        ...
        expect(f).toThrow('User doesn\'t exist')
    });
  
    it("should throw exception 'No user id'", function(){
        var mockDb = jasmine.createSpyObj('db', ['get', 'push', 'write', 'find', 'value']);
        mockDb.get.and.returnValue(mockDb);
        mockDb.push.and.returnValue(mockDb);
        mockDb.find.and.returnValue(mockDb);
  ...
  describe("UserRepository", function() {
    ...
    it("should throw exception 'User object is not define'", function(){
        var mockDb = jasmine.createSpyObj('db', ['get', 'push', 'write', 'find', 'value']);
        mockDb.get.and.returnValue(mockDb);
        mockDb.push.and.returnValue(mockDb);
        mockDb.find.and.returnValue(mockDb);
        ...
        expect(f).toThrow('User object is not define')
    });
